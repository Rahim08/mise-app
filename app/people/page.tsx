...
function PeopleApp({ restaurantId }: { restaurantId: string }) {
  ...
  const TABS = [
    ...
    { id: 'ops', label: 'Зал', icon: (a: boolean) => <svg fill="none" stroke="currentColor" strokeWidth={a ? 2.2 : 1.8} viewBox="0 0 24 24" width="25" height="25"><path d="M3 3v18M8 3v6a3 3 0 01-3 3M14 21V3c-1.7 0-3 2.7-3 6 0 2.5 1.3 4.2 3 4.5M19 3v18M19 3c-1.7 0-3 3-3 6s1.3 6 3 6" /></svg> },
