...
let STRINGS: [String: [Lang: String]] = [
    ...
    "refreshFailed": tr("Couldn’t refresh — showing saved data", "Не удалось обновить — данные прежние", "Aggiornamento non riuscito — dati salvati", "Échec de l’actualisation — données sauvegardées", "Yenilənmədi — köhnə məlumat", "Yenilenemedi — kayıtlı veriler", "Не вдалося оновити — старі дані", "Жаңарту сәтсіз — ескі деректер"),
