...
let STRINGS: [String: [Lang: String]] = [
    ...
    "an.byType":         tr("By hookah type", "По видам кальяна", "Per tipo di narghilè", "Par type de chicha", "Nargilə növünə görə", "Nargile türüne göre", "За видом кальяну", "Кальян түрі бойынша"),
