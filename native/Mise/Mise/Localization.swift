...
let STRINGS: [String: [Lang: String]] = [
    ...
    "pe.role.hookah":    tr("Hookah", "Кальян", "Narghilè", "Chicha", "Kalyan", "Nargile", "Кальян", "Кальян"),
    ...
    "ob.feat3":          tr("Tobacco stock", "Склад табака", "Magazzino tabacco", "Stock de tabac", "Tütün anbarı", "Tütün stoku", "Склад тютюну", "Темекі қоймасы"),
    ...
    "ob.feat8":          tr("Hookah shift", "Кальянная смена", "Turno narghilè", "Service chicha", "Kalyan növbəsi", "Nargile vardiyası", "Кальянна зміна", "Кальян ауысымы"),
    ...
    "ob.notifDesc":      tr("New orders, low tobacco, shift end — on time.", "Новые заказы, заканчивающийся табак, конец смены — вовремя.", "Nuovi ordini, tabacco in esaurimento, fine turno — in tempo.", "Nouvelles commandes, tabac bas, fin de service — à temps.", "Yeni sifarişlər, bitən tütün, növbə sonu — vaxtında.", "Yeni siparişler, biten tütün, vardiya sonu — zamanında.", "Нові замовлення, тютюн закінчується, кінець зміни — вчасно.", "Жаңа тапсырыстар, бітіп жатқан темекі, ауысым соңы — уақытында."),
    ...
    "ob.geoDesc":        tr("The “I’m here” check-in works by the venue location.", "Отметка «Я пришёл» на смене работает по месту заведения.", "Il check-in “Sono qui” funziona in base alla posizione del locale.", "Le pointage « Je suis là » fonctionne selon le lieu de l’établissement.", "«Gəldim» qeydi məkanın yerinə görə işləyir.", "“Geldim” girişi mekan konumuna göre çalışır.", "Відмітка «Я прийшов» працює за місцем закладу.", "«Келдім» белгісі орын орналасуы бойынша жұмыс істейді."),
