...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mise",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Mise15LocationOneShot")
@interface LocationOneShot : NSObject <CLLocationManagerDelegate>
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)m;
- (void)locationManager:(CLLocationManager * _Nonnull)m didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locs;
...
SWIFT_CLASS("_TtC4Mise17LocationRequester")
@interface LocationRequester : NSObject <CLLocationManagerDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC4Mise9ScannerVC")
